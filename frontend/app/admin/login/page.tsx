      ...
      <div className="mx-auto flex min-h-screen max-w-md items-center">
        <section className="app-shell-panel w-full p-6 sm:p-8">
          ...
          <div className="mt-6 rounded-3xl bg-surface-50 px-5 py-5">
            ...
            <h1 className="mt-2 text-3xl font-bold tracking-tight text-brand-900">Admin sign in</h1>
            <p className="mt-2 text-sm leading-6 text-surface-600">Access events, approvals, templates, and platform operations from one workspace.</p>
          </div>
