...
exports.sendSmsRsvpInvite = sendSmsRsvpInvite;
exports.sendEmailRsvpInvite = sendEmailRsvpInvite;
 ...
 */
async function sendSmsRsvpInvite(to, input) {
    ...
    try {
        ...
        return { success: false, mode: 'sms', error: error.message };
    }
}
async function sendEmailRsvpInvite(to, input) {
  ...
  `;
    ...
    try {
        ...
        return { success: result.success !== false, mode: 'email', error: result.success === false ? result.error : undefined };
    }
    catch (error) {
        return { success: false, mode: 'email', error: error.message };
    }
}
// ============================================
...
async function sendInvitationWhatsApp(invitationId) {
    ...
    const checkInUrl = buildEventPublicUrl(invitation.event.slug, `/checkin?code=${invitation.accessCode}`, invitation.event.domains);
