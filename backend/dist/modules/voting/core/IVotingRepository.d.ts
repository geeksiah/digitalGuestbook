import type { PaymentIntent, VoteGrant, VoteRecord, VotingContest, VotingEventConfig, VotingOption } from '@prisma/client';
import type { VotingConfigInput, VotingResultRow } from './types.js';
export interface VotingEventLite {
    id: string;
    slug: string;
    name: string;
    ownerId: string | null;
...
//# sourceMappingURL=IVotingRepository.d.ts.map